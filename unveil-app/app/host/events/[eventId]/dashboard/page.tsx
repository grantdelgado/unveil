...
const EventSummaryCard = dynamic(
  () => import('@/components/features/host-dashboard/EventSummaryCard').then((mod) => ({ default: mod.EventSummaryCard })),
  {
    loading: () => (
    ...
    ssr: true, // Event summary can be SSR'd
  }
);

const ModernActionList = dynamic(
  () => import('@/components/features/host-dashboard/ModernActionList').then((mod) => ({ default: mod.ModernActionList })),
  {
    loading: () => (
      <div className="animate-pulse space-y-4 bg-white rounded-lg border p-6">
    ...
    ssr: true, // Action list can be SSR'd
  }
);

// Lazy load header component
const CompactEventHeader = dynamic(
  () => import('@/components/features/host-dashboard/CompactEventHeader').then((mod) => ({ default: mod.CompactEventHeader })),
  {
    loading: () => (
