...
interface ProvidersStep2Props {
  children: ReactNode;
}

/**
 * STEP 2: QueryClient + Minimal Auth
 * Add basic auth state management without complex dependencies
 */
export function ProvidersStep2({ children }: ProvidersStep2Props) {
  // Log provider mount for observability (PII-safe, dev only)
  if (typeof window !== 'undefined' && process.env.NODE_ENV === 'development') {
    console.info('[ProvidersStep2] mounted - QueryClient + MinimalAuth');
  }
