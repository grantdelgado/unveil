...
test.describe('Guest Message Join Boundary', () => {
  test('should show join boundary for guest who joined after messages were sent', async ({ page }) => {
    ...
    await expect(joinBoundary).toHaveAttribute('aria-label', /You joined this event on .+ Messages above were sent before you joined\./);
  ...
  test('should not show join boundary if guest joined before any messages', async ({ page }) => {
    // This test assumes we have test data set up with:
  ...
  test('should not show join boundary if guest joined after all messages', async ({ page }) => {
    // This test assumes we have test data set up with:
  ...
  test('boundary should be mobile-friendly and accessible', async ({ page }) => {
  ...
  test('should handle timezone formatting correctly', async ({ page }) => {
    ...
    const dateText = await joinBoundary.locator('text=You joined on').textContent();
